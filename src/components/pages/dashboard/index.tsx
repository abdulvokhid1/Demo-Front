    ...
    return (
        ...
        <div className={sliderVisible ? "container" : "container_hide"} id="depth2_leftmenu"
                                    ...
                                    <table className="form_TB" summary="검색항목" style={{border: '0px'}}>
                                        ...
                                        <tr>
                                            <td className="conts" style={{border: '0px'}}>
                                                ...
                                                <span className="custom-combobox" style={{display: 'none'}}>
                                                <input title=""
                                                ...
                                                <a tabIndex={-1} title="모두보기"
                                                   className={!isSelectedHover ? "ui-button ui-widget ui-state-default ui-button-icon-only custom-combobox-toggle ui-corner-right" :
                                                   ...
                                                   onMouseOver={() => {
                                                       selectionHoverHandler(true)
                                                   }}
                                                   onMouseOut={() => {
                                                       selectionHoverHandler(false)
                                                   }}
                                                   onClick={() => {
                                                       selectionClickedHandler(true)
                                                   }}
                                                >
                                                    <span
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-8">
                                                        <div className="media-body text-right">
                                                            ...
                                                            <h4 className="mb-0 text-align" style={{
                                                                width: '180px',
                                                                fontWeight: '500px',
                                                                lineHeight: '1.2rem'
                                                            }}>
                                    ...
                                    <div className="row mt-5"
                                        ...
                                        <div className="col-12">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-8 text-right text-align">
                                            ...
                                            <div className="btn_wrap_tid" style={{float: 'right'}}>
                                                ...
                                                <a href="#none" className="copy copy_btn_owner"
                                                   ...
                                                   data-clipboard-target="#en_url_owner" style={{}}>
                                                    <img src="/images/menu_icon_copy_blue.jpg"
            ...
            <ul className="ui-autocomplete ui-front ui-menu ui-widget ui-widget-content" id="ui-id-1" tabIndex={0}
                style={{display: isSelectedClicked? 'block': 'none',
                    position: 'absolute', top: '167.5px', left: '250px',
                    width: '300px',
                    fontFamily:'Verdana, Arial, sans-serif',
                    fontSize:'1.1em'
                }}>
                <li className={"ui-menu-item"} id="ui-id-717" tabIndex={-1}>운영자 - 2000001</li>
                <li className="ui-menu-item" id="ui-id-718" tabIndex={-1}>회사원1 - 2000002</li>
                <li className="ui-menu-item" id="ui-id-719" tabIndex={-1}>회사원2 - 2000003</li>
                <li className="ui-menu-item" id="ui-id-720" tabIndex={-1}>회사원3 - 2000004</li>
                <li className="ui-menu-item" id="ui-id-721" tabIndex={-1}>회사원4 - 2000005</li>
                <li className="ui-menu-item" id="ui-id-722" tabIndex={-1}>회사원5 - 2000006</li>
                <li className="ui-menu-item" id="ui-id-723" tabIndex={-1}>회사원6 - 2000007</li>
                <li className="ui-menu-item" id="ui-id-724" tabIndex={-1}>조경순 - 2000008</li>
                <li className="ui-menu-item" id="ui-id-725" tabIndex={-1}>심광중 - 2000009</li>
                <li className="ui-menu-item" id="ui-id-726" tabIndex={-1}>김상일 - 2000010</li>
                <li className="ui-menu-item" id="ui-id-727" tabIndex={-1}>장기순 - 2000011</li>
                <li className="ui-menu-item" id="ui-id-728" tabIndex={-1}>안병해 - 2000012</li>
                <li className="ui-menu-item" id="ui-id-729" tabIndex={-1}>유정희 - 2000013</li>
                <li className="ui-menu-item" id="ui-id-730" tabIndex={-1}>김희숙 - 2000014</li>
                <li className="ui-menu-item" id="ui-id-731" tabIndex={-1}>김정옥 - 2000015</li>
                <li className="ui-menu-item" id="ui-id-732" tabIndex={-1}>김광분 - 2000016</li>
                <li className="ui-menu-item" id="ui-id-733" tabIndex={-1}>최복순 - 2000017</li>
                <li className="ui-menu-item" id="ui-id-734" tabIndex={-1}>박양길 - 2000018</li>
                <li className="ui-menu-item" id="ui-id-735" tabIndex={-1}>박양길2 - 2000019</li>
                <li className="ui-menu-item" id="ui-id-736" tabIndex={-1}>김승완 - 2000020</li>
                <li className="ui-menu-item" id="ui-id-737" tabIndex={-1}>김은빈 - 2000021</li>
                <li className="ui-menu-item" id="ui-id-738" tabIndex={-1}>김병은 - 2000022</li>
                <li className="ui-menu-item" id="ui-id-739" tabIndex={-1}>김희숙2 - 2000023</li>
                <li className="ui-menu-item" id="ui-id-740" tabIndex={-1}>최난희 - 2000024</li>
                <li className="ui-menu-item" id="ui-id-741" tabIndex={-1}>김진수 - 2000025</li>
                <li className="ui-menu-item" id="ui-id-742" tabIndex={-1}>이재형 - 2000026</li>
                <li className="ui-menu-item" id="ui-id-743" tabIndex={-1}>이대순 - 2000027</li>
                <li className="ui-menu-item" id="ui-id-744" tabIndex={-1}>전경희 - 2000028</li>
                <li className="ui-menu-item" id="ui-id-745" tabIndex={-1}>김제남 - 2000029</li>
                <li className="ui-menu-item" id="ui-id-746" tabIndex={-1}>김제남2 - 2000030</li>
                <li className="ui-menu-item" id="ui-id-747" tabIndex={-1}>김정혜 - 2000031</li>
                <li className="ui-menu-item" id="ui-id-748" tabIndex={-1}>박지민 - 2000032</li>
                <li className="ui-menu-item" id="ui-id-749" tabIndex={-1}>서문숙 - 2000033</li>
                <li className="ui-menu-item" id="ui-id-750" tabIndex={-1}>김정자 - 2000034</li>
                <li className="ui-menu-item" id="ui-id-751" tabIndex={-1}>김은빈2 - 2000035</li>
                <li className="ui-menu-item" id="ui-id-752" tabIndex={-1}>김희숙3 - 2000036</li>
                <li className="ui-menu-item" id="ui-id-753" tabIndex={-1}>서문숙2 - 2000037</li>
                <li className="ui-menu-item" id="ui-id-754" tabIndex={-1}>조윤순 - 2000038</li>
                <li className="ui-menu-item" id="ui-id-755" tabIndex={-1}>김옥진 - 2000039</li>
                <li className="ui-menu-item" id="ui-id-756" tabIndex={-1}>윤귀분 - 2000040</li>
                <li className="ui-menu-item" id="ui-id-757" tabIndex={-1}>윤여자 - 2000041</li>
                <li className="ui-menu-item" id="ui-id-758" tabIndex={-1}>전수경 - 2000042</li>
                <li className="ui-menu-item" id="ui-id-759" tabIndex={-1}>김옥진2 - 2000043</li>
                <li className="ui-menu-item" id="ui-id-760" tabIndex={-1}>라삼순 - 2000044</li>
            </ul>
        </div>
        // </div>
    )
