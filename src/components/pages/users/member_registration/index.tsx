...
import { sweetErrorAlert, sweetTopSuccessAlert } from "@/utils/sweetAlert";
...
const UserManagement = () => {
  ...
  const [sponNameState, setSponNameState] = useState<string>("");
  const [formData, setFormData] = useState();
  const [recomId, setRecomId] = useState<number>(0);
  const [sponId, setSponId] = useState<number>(0);
  ...
  useEffect(() => {
    const recomid = searchParams.get("recomid") || undefined;
    const name = searchParams.get("name") || "";
    setRecomId(Number(recomid));
    setNameState(name);
  }, []);
  useEffect(() => {
    const sponid = searchParams.get("sponid") || undefined;
    const sponName = searchParams.get("name") || "";
    setSponId(Number(sponid));
    setSponNameState(sponName);
  }, []);
  useEffect(() => {
    setSelectedKey(0);
  }, []);
  ...
  const onSubmit = async (formData: FormData) => {
    ...
    const sponid = formData.get("sponid_hidden");
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="conts">
                      ...
                      <span className="shop_btn_pack" style={{ float: "none" }}>
                        &nbsp;
                        <a onClick={() => {}} className="small gray">
                          아이디검색
                        </a>{" "}
                        &nbsp;
                        <a onClick={() => {}} className="small darkgray">
                          선택취소
                        </a>
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className="conts">
                      ...
                      <br />
                      <label>
                        <input type="checkbox" name="prod_chk_free" value="Y" />{" "}
                        인정 매출시 체크
                      </label>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td className="article">
                      비밀번호<span className="ic_ess" title="필수"></span>
                    </td>
                    <td className="conts">
                      <input
                        type="password"
                  ...
                  <tr>
                    ...
                    <td className="conts">
                      <input className="input_text" type="text" name="email" />
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="conts">
                      <input
                        ...
                        defaultValue={sponId}
                        // onChange={(e) => {
                        //   setSponId(Number(e.target.value));
                        // }}
                      />
                      <input
                        type="text"
                      ...
                      <span className="shop_btn_pack" style={{ float: "none" }}>
                        ...
                        <a
                          onClick={() => {
                            window.open(
                              PAGE_ROUTES.USERS.USERSPON_LOOKUP,
                              "후원인 검색 페이지",
                              "height=600px, width=900px"
                            );
                          }}
                  ...
                  {/* <tr>
                    ...
                    <td className="conts">
                      ...
                      <span className="shop_btn_pack" style={{ float: "none" }}>
                        &nbsp;
                        <a onClick={() => {}} className="small blue">
                          후원인 검색
                        </a>
                      </span>
                    </td>
