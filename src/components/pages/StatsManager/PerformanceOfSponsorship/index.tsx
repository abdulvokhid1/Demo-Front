               ...
               <div className="content_section">
                <div className="content_section_fix" style={{background:'#fff'}}>
                  ...
                  <div className="title_area">
                    ...
                    <span className="location">홈 &gt; 통계관리 &gt; 회원실적 후원</span>
                  </div>
                  {/* <!-- // 페이지타이틀 --> */}
					...
					<table className="list_TB" summary="리스트기본">
						<thead>
							<tr>
								...
								<th scope="col" className="colorset"><u>좌</u></th>
								<th scope="col" className="colorset"><u>우</u></th>
								<th scope="col" className="colorset"><u>하위전체(명)</u></th>
								<th scope="col" className="colorset"><u>하위전체</u></th>
...
function chk_gonumber(val) {
    ...
    export default PerformanceOfSponsorship;