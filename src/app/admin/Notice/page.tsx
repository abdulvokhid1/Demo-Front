...
import './styles.css';
const Notice = ({component, PageProps}: AppProps) => {
  return(
...
<table className="form_TB" summary="검색항목">
	...
	<tbody> 
		<tr>
			...
			<td className="conts">
                <input type="text" name="pass_inid" className="input_text" style={{width:100}} value=""/></td>

		</tr>
		<tr>
			<td className="article">등록자명</td>
			<td className="conts">
                <input type="text" name="pass_writer" className="input_text" style={{width:100}} value=""/></td>
...
<div className="top_btn_area">
	<div className="btn_line_up_center">
		...
		<span className="shop_btn_pack"><a href="_bbs.post_notice.form.php?_mode=add" className="medium red" title="게시물등록">게시물등록</a></span>
...
<div className="ctl_btn_area">
	...
	<span className="shop_btn_pack"><span className="blank_3"></span></span>
	<span className="shop_btn_pack"><a href="#none" className="small white" title="선택해제" onClick={() =>{'selectAll'}}>선택해제</a></span>
	<span className="shop_btn_pack"><span className="blank_3"></span></span>
	<span className="shop_btn_pack"><a href="#none" className="small gray" title="선택삭제" onClick={() =>{'selectAll'}}>선택삭제</a></span>
</div>
	...
	<tbody> 
			<tr>
				...
				<td style={{text-align,left!important}}>,
                    <span className="shop_state_pack"><span className="orange">공지</span></span> 테스트중입니다.</td>
				<td>관리자</td>
				<td>2023-07-02</td>
				<td>
					<div className="btn_line_up_right">
						<span className="shop_btn_pack"><a href="_bbs.post_notice.form.php?_mode=modify&amp;_uid=1&amp;_PVSC=" className="small white" title="수정">수정</a>
                        </span>
						<span className="shop_btn_pack">
                            <span className="blank_3"></span>
                        </span>
						<span className="shop_btn_pack">
                            <a href="#none" onClick= {() =>{del(&quot;_bbs.post_notice.pro.php?_mode=delete&amp;_uid=1&amp;_PVSC=&quot;)} className="small gray" title="삭제">삭제</a>
                        	                            <span className="shop_btn_pack">
                              <span className="blank_3"></span>
                            </span>
                        </div>
                ...
                <span className="btn"><span className="no">
                    <span className="icon ic_first"></span>
                        ...
                        <span className="icon ic_first"></span></a></span><span className="btn">
                            <span className="no">
                                <span className="icon ic_prev"></span></span><a href=" ?pass_menu=&amp;&amp;listpg=0" className="ok" title="이전">
                                    ...
                                    <span className="nextprev"><span className="btn"><span className="no">
                                        <span className="icon ic_next"></span></span><a href=" ?pass_menu=&amp;&amp;listpg=2" className="ok" title="다음">
                                            <span className="icon ic_next"></span></a></span>
                                        <span className="btn"><span className="no">
                                            <span className="icon ic_last"></span></span><a href=" ?pass_menu=&amp;&amp;listpg=1" className="ok" title="끝">
