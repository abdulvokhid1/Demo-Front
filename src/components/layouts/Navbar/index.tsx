                ...
                <div className="nav_admin_box">
                    <ul>
                        ...
                        <li className={selectedKey==2? "hit": ""}>
                            <Link href="http://thesen.moinus.kr/myAdmin/_entershop.entry_revenues_list.php" className="btn"
                        ...
                        <li className={selectedKey==4? "hit": ""}>
                            <Link href="http://thesen.moinus.kr/myAdmin/_cardsys.sub_tree_sponid_frame.php" className="btn"
                        ...
                        <li className={selectedKey==6? "hit": ""}>
                            <Link href="http://thesen.moinus.kr/myAdmin/_entershop.bonus_no_total_exchange.php" className="btn"
