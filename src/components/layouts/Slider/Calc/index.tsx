...
const Slider = () => {
    return (
        <div className="aside_second">
            ...
            <a href="PositionCalc" className="menu" title="판매 인센티브" style={{display: 'block'}}>직급 인센 정산</a>
            ...
            <a href="PositionIncentiveLists" className="menu" title="판매 인센티브" style={{display: 'block'}}>직급 인센 정산 내역</a>
            <a href="RecomenIncenList" className="menu" title="판매 인센티브" style={{display: 'block'}}>추천 인센 정산 내역</a>
            <a href="SponsorshipIncenList" className="menu" title="판매 인센티브" style={{display: 'block'}}>후원 인센 정산 내역</a>
