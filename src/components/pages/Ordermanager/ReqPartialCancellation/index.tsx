      ...
      <div className="content_section">
        <div className="content_section_fix" style={{ background: "#fff" }}>
          ...
          <div className="title_area">
            ...
            <span className="title">부분취소요청관리</span>
                  ...
                  <tr>
                    <td className="conts" colSpan={6}>
                      ...
                      <div className="guide_text">
                        <span className="ic_blue"></span>
                        <span className="blue">
                          카드결제는 취소처리시 PG 연동되며, 전액적립금결제를
                          제외한 다른 결제수단일 경우 환불계좌로 송금 후
                          처리하시기 바랍니다.
                        </span>
                      </div>
                      <div className="guide_text">
                        <span className="ic_blue"></span>
                        <span className="blue">포</span>
                      </div>
                      인트로 환불을 요청한 경우 PG 연동되지 않으며 처리 즉시
                      고객 적립금으로 환불됩니다.
                      <div className="guide_text">
                        <span className="ic_blue"></span>
                        <span className="blue">
                          <b>
                            취소 요청한 금액보다 상계가능한 정산예정금액이
                            부족할 경우 부분취소가 불가능합니다. 이러한 경우
                            PG사에 문의하시기 바랍니다.
                          </b>
                        </span>
                      </div>
          ...
          >
            ...
            <input
              type="hidden"
              name="_search_que"
              value="IHdoZXJlIDEgIEFORCAob3Aub3BfY2FuY2VsID0gJ1knIE9SIG9wLm9wX2NhbmNlbCA9ICdSJyk="
            />
