                ...
                <div className="content_section_fix" style={{background: '#fff'}}>
                        ...
                        <div className="form_box_area">
                            <table className="form_TB" summary="검색항목">
                                ...
                                <tr>
                                    ...
                                    <td className="conts"><input type="text" name="pass_name" className="input_text"
                                                                 value=""/></td>
                                    <td className="article">상품코드</td>
                                    <td className="conts"><input type="text" name="pass_code" className="input_text"
                                                                 value=""/></td>
                                    <td className="article">판매여부</td>
                                    <td className="conts"><select name='sale_enddate'>
                                        <option value=''>-선택-</option>
                                        <option value='N'>판매중인상품</option>
                                        <option value='Y'>종료상품</option>
                                    </select></td>
                                    <td className="article">공급업체</td>
                                    <td className="conts"><select name='pass_customerCode'>
                                        <option value=''>-공급업체-</option>
                                        <option value='superadmin'>더센2(아이디 : superadmin)</option>
                                    </select></td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="conts"><select name='pass_p_view'>
                                        <option value=''>-선택-</option>
                                        <option value='N'>숨김</option>
                                        <option value='Y'>노출</option>
                                    </select></td>
                                    <td className="article">상품추천인MD</td>
                                    <td className="conts"><input type="text" name="md_name" className="input_text"
                                                                 value=""/></td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="conts" colSpan={7}>
                                        ...
                                        3차분류 : <select name='cateCode' id="pass_parent03">
                        ...
                        <div className="form_box_area excel_upload_field" style={{display: 'none'}}>
                                ...
                                <tr>
                                    <td className="conts" colSpan={2}>
                                        <div className='guide_text'><span className='ic_blue'></span><span
                                            className='blue'>상품 <b>등록</b>시 상품분류(카테고리)는 1개만 지정 가능하며 이미 등록되어있지 않은 분류(카테고리)는 제외 됩니다.</span>
                                        </div>
                                        <div className='guide_text'><span className='ic_blue'></span><span
                                            className='blue'>상품 <b>수정</b>시 상품분류(카테고리) 설정은 무시됩니다.</span></div>
                                        <div className='guide_text'><span className='ic_blue'></span><span
                                            className='blue'>상품 분류 추가/변경은 <b>업로드 수정/확인</b>에서 가능합니다. </span></div>
                                        <div className='guide_text'><span className='ic_blue'></span><span
                                            className='blue'><b>업로드 파일</b>은 <b>최대 20M까지 업로드 가능</b> 합니다.</span></div>
                                        <div className='guide_text'><span className='ic_blue'></span><span
                                            className='blue'><b>업로드 용량</b>에 따라 <b>다소시간이 걸릴 수 있습니다.</b></span></div>
                                        <div className='guide_text'><span className='ic_blue'></span><span
                                            className='blue'>엑셀내용중 <b>엔터</b>는 <b>생략</b> 하시고 입력 바랍니다.</span></div>
                                        <div className='guide_text'><span className='ic_blue'></span><span
                                            className='blue'><b>상품 사용 정보</b>, <b>업체 이용 정보</b>, <b>상품상세설명</b>, <b>상품 상세설명 (모바일)</b>, <b>주문확인서 주의사항</b>의 내용은 엔터를 제외 하고 <b>HTML로 입력</b> 바랍니다.  </span>
                                        </div>
                                        <div className='guide_text'><span className='ic_blue'></span><span
                                            className='blue'>상품이미지가 <b>외부이미지</b>일 경우 <b>http://</b>부터 시작하도록 입력 바랍니다.</span>
                                        </div>
                                        <div className='guide_text'><span className='ic_blue'></span><span
                                            className='blue'>상품이미지가 <b>내부이미지</b>일 경우 <b>./upfiles/product/ 폴더에 사전 업로드</b>를 하시고 엑셀에는 <b>파일명과 확장자만 입력</b> 바랍니다.</span>
                                        </div>
                                        <div className='guide_text'><span className='ic_blue'></span><span
                                            className='blue'>엑셀내용중 금액 또는 수수료의 <b>%</b>, <b>콤마(,)</b>, <b>원</b> 등을 <b>기호를 생략</b> 하세요.</span>
                                        </div>
                                        <div className='guide_text'><span className='ic_blue'></span><span
                                            className='blue'>일괄업로드는 <b>파일업로드</b> - <b>업로드 수정/확인</b> - <b>등록처리</b> 단계를 거쳐 처리됩니다.</span>
                                        </div>
                            ...
                            <div className="top_btn_area">
                                <div className="btn_line_up_center">
                                    <span className="shop_btn_pack btn_input_blue"><input type="submit"
                                                                                          className="input_medium"
                                                                                          title="일괄업로드" value="일괄업로드"/></span>
                                    <span className="shop_btn_pack"><span className="blank_3"></span></span>
                                    <span className="shop_btn_pack"><a href="_product_main.download.php"
                                                                       className="medium white"
                                                                       title="엑셀다운로드">엑셀다운로드</a></span>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <form name='frm' method='post' action="_product_main.pro.php" target="common_frame">
                        ...
                        <div className="content_section_inner">
                            ...
                            {/* <!-- 리스트 제어버튼영역 //--> */}
                            <div className="top_btn_area">
                                <span className="shop_btn_pack"><a href="#none" className="small gray" title="선택순위수정"
                                                                   onClick={() => {
                                                                   }}>선택순위수정</a></span>
                                <span className="shop_btn_pack"><span className="blank_3"></span></span>
                                <span className="shop_btn_pack"><a href="javascript:p_view('Y');" className="small red"
                                                                   title="노출">노출</a></span>
                                <span className="shop_btn_pack"><span className="blank_3"></span></span>
                                <span className="shop_btn_pack"><a href="javascript:p_view('N');" className="small gray"
                                                                   title="숨김">숨김</a></span>
                                <span className="shop_btn_pack"><span className="blank_3"></span></span>
                                <span className="shop_btn_pack" style={{float: 'right'}}><a href="#none"
                            ...
                            <table className="list_TB" summary="리스트기본">
                                ...
                                {/* 리스트단락시작 */}
                                <tr>
                                    <td><input type='checkbox' name='serialnum[]' value='10'
                                               className='className_ordernum className_pcode'/></td>
                                    <td>
                                        노출<br/>
                                        <input type='text' name='chk_idx[6]' value='999' className='input_text'
                                               style={{width: '30px'}}/>
                                    </td>
                                    <td>10</td>
                                    <td><a href='_entershop.member.form.php?_mode=modify&app_mode=popup&id=superadmin'
                                           onClick={() => {
                                           }}><b>superadmin</b></a></td>
                                    <td><img src='http://thesen.moinus.kr/upfiles/product_t31/100x100_'
