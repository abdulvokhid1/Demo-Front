                ...
                userListState.map((item, index) => {
                    return (
                        <tr key={item.id} className="selectToggle" style={{cursor: 'pointer'}}>
                            <td>{index+1}</td>
                            <td>
                                <input id="isRelation" type="radio" name="id" value={item.id} onChange={() => {
                        ...
                        <div className="btn_line_up_center">
                            <span className="shop_btn_pack btn_input_blue">
                                <input type="button" className="input_medium" title="선택적용" value="선택적용"
                                       onClick={() => {
                                           const recomid_hidden = window.opener.document.getElementById('recomid_hidden');
                                           recomid_hidden.value = idState;
                                           const recomid_display = window.opener.document.getElementById('recomid_display');
