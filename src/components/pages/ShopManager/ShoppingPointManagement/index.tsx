              ...
              <div className="content_section">
                <div className="content_section_fix" style={{background:'#fff'}}>
                  ...
                  <div className="title_area">
                    ...
                    <span className="location">홈 &gt; 회원관리 &gt; 쇼핑포인트 지급관리</span>
                  </div>
                  {/* <!-- // 페이지타이틀 --> */}
...
<form name='searchfrm' method='post' action='/myAdmin/_entershop.point_mpoint.list.php'>
<input type='hidden' name='mode' value='search'/>
				...
				<div className="form_box_area">
					...
					<div className="top_btn_area">
						<div className="btn_line_up_center">
							...
							<span className="shop_btn_pack"><a href="_entershop.point_mpoint.form.php?_loc=&_mode=add" className="medium red" title="관리자 적립" >관리자 적립</a></span>
						</div>
					</div>
									</div>
</form>
            ...
            <input type='hidden' name='search_que' value="IHdoZXJlIHBvX3R5cGUgPSAnQVVUSCcg"/>
					...
					<table className="list_TB" summary="리스트기본">
						...
						<thead>
							<tr>
								...
								<th scope="col" className="colorset">지급포인트</th>
								<th scope="col" className="colorset">차감포인트</th>
...
<tr><td colSpan={10} height='40'>내용이 없습니다.</td></tr>	
 ...
 export default ShoppingPointManagement;