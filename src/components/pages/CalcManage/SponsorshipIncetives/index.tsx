		...
		<thead>
            ...
            <td colSpan={10} className ="new_order_data_sum">
					...
					<div className="inner_sum_box">
						<ul>
							<li className="txt">2024-03-15 전체매출( P)<span className="value">0</span></li>
						</ul>
					</div>
{/* <!--
상품테이블 에서 매출 가져옴
					...
					<div className="inner_sum_box">
						<ul>
							<li className="txt">2024-03-15 전체매출 PV<span className="value">0 PV</span></li>
							<li className="txt">2024-03-15 전체매출(원)<span className="value">0 원</span></li>
						</ul>
					</div>
--> */}
				</td>
		...
		<table className="list_TB" summary="리스트기본">
			<thead>
				<tr style={{height:'50px align: center'}}>
					...
					<th scope="col" className="colorset">대상ID</th>
					<th scope="col" className="colorset">회원명</th>
					<th scope="col" className="colorset">매출ID</th>
					<th scope="col" className="colorset">매출금액</th>
					<th scope="col" className="colorset">매출(인정)</th>
					<th scope="col" className="colorset">추천인수</th>
					<th scope="col" className="colorset">적용%</th>
					<th scope="col" className="colorset">지급예정금액</th>
				</tr>
			</thead> 
...
export default SponsorshipIncetives;