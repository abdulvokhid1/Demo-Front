		...
		<table className="form_TB" summary="검색항목">
			...
			<tbody>
				<tr>
					...
					<td className="conts">
					  <input type="radio" name='search_ptype' id="p_type2" value="year" onClick={()=>{}}   checked={true}/>
					  <label htmlFor='p_type2' style={{height:'18px'}}>년도별</label>
					  &nbsp;
					  <input type="radio" name='search_ptype' id="p_type3" value="month" onClick={()=>{}}  />
					  ...
					  &nbsp;
					  --> */}
					  <input type="radio" name='search_ptype' id="p_type5" value="day" onClick={()=>{}}  />
					  <label htmlFor='p_type5' style={{height:'18px'}}>일별</label>
					  &nbsp;
					  <input type="radio" name='search_ptype' id="p_type1" value="all" onClick={()=>{}} />
					...
					<td className="conts">
						...
						<select name="sh_month" id="sh_month" onChange={()=>{}} style={{display:'none'}}>
						...
						<select name="sh_day" id="sh_day" onChange={()=>{}}  style={{display:'none'}}>
							<option  value='01'>01일</option><option  value='02'>02일</option><option  value='03'>03일</option><option  value='04'>04일</option><option  value='05'>05일</option><option  value='06'>06일</option><option  value='07'>07일</option><option  value='08'>08일</option><option  value='09'>09일</option><option  value='10'>10일</option><option  value='11'>11일</option><option  value='12'>12일</option><option  value='13'>13일</option><option  selected={true} value='14'>14일</option><option  value='15'>15일</option><option  value='16'>16일</option><option  value='17'>17일</option><option  value='18'>18일</option><option  value='19'>19일</option><option  value='20'>20일</option><option  value='21'>21일</option><option  value='22'>22일</option><option  value='23'>23일</option><option  value='24'>24일</option><option  value='25'>25일</option><option  value='26'>26일</option><option  value='27'>27일</option><option  value='28'>28일</option><option  value='29'>29일</option><option  value='30'>30일</option><option  value='31'>31일</option>						</select>
				...
				<tr>
					...
					<td className="conts">
					  <input type="radio" name='bonus_status' id="bonus_status" value=""  checked={true}/>
					...
					<td className="conts">
						...
						<input type='text' name='stx' style={{width:'90%'}} value="" className='input_text'/>
					</td>
				</tr>
				</tbody> 
		</table>
...
<div className="new_deny_tab">
    ...
    <div className="top_btn_area">
			<span className="shop_btn_pack"><a href="javascript:select_send('excel_center');" className="small white" title="선택엑셀저장" >선택엑셀저장</a></span>
    ...
    {/* <a href='/myAdmin/_entershop.bonus_no_total_exchange.php?code=&page=&filed=total&orderby=asc'> */}
		{/* <u>매칭보너스</u></a></th><th scope='col' className='colorset'><a href='/myAdmin/_entershop.bonus_no_total_exchange.php?code=&page=&filed=total&orderby=asc'> */}
			<u>대리점 보너스</u></a></th><th scope='col' className='colorset'><a href='/myAdmin/_entershop.bonus_no_total_exchange.php?code=&page=&filed=total&orderby=asc'>
								...
								<th scope="col" className="colorset"><a href='/myAdmin/_entershop.bonus_no_total_exchange.php?code=&page=&filed=total&orderby=asc'><u>적립공제</u></a></th>
								<th scope="col" className="colorset"><a href='/myAdmin/_entershop.bonus_no_total_exchange.php?code=&page=&filed=total&orderby=asc'><u>기타공제</u></a></th>
								<th scope="col" className="colorset"><a href='/myAdmin/_entershop.bonus_no_total_exchange.php?code=&page=&filed=total&orderby=asc'><u>실수령액</u></a></th>		
								<th scope="col" className="colorset"><a href='/myAdmin/_entershop.bonus_no_total_exchange.php?code=&page=&filed=reg_date&orderby=asc'><u>기간</u></a></th>	
								<th scope="col" className="colorset"><a href='/myAdmin/_entershop.bonus_no_total_exchange.php?code=&page=&filed=total&orderby=asc'><u>상태</u></a></th>
							...
							<tr>
								<td colSpan={20} className="new_order_data_sum">
										...
										<ul style={{fontSize:'12px'}}>
											...
											<li><span className="sum" style={{fontSize:'12px'}}>금액합계</span><span className="value" style={{fontSize:'13px'}}>0</span></li>
											{/* <!--<li><span className="sum">배송비</span><span className="value">0</span></li>--> */}
											<li><span className="sum" style={{fontSize:'12px'}}>세금공제</span><span className="value" style={{fontSize:'13px'}}>0</span></li>
											<li><span className="sum" style={{fontSize:'12px'}}>적립공제</span><span className="value">0</span></li>
											<li><span className="sum" style={{fontSize:'12px'}}>기타공제</span><span className="value" style={{fontSize:'13px'}}>0</span></li>
											<li><span className="sum" style={{fontSize:'12px'}}>실수령액</span><span className="value" style={{fontSize:'13px'}}>0</span></li>
											<li><span className="sum" style={{fontSize:'12px',fontWeight:'bold'}}>정산합계</span><span className="value">0</span></li>
