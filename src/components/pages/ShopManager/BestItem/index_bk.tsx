...
function update_type_name() {
	...
	xmlHttp.open("GET", "_product_main_setup.list.php?_mode=update_type_name&_type_name_update=" + type_nm + "&_type_update=" + "best", true);
	xmlHttp.send(null);
                    ...
                    <form name='frm' method='post' action="_product_main_setup.pro.php">
                        ...
                        <div className="content_section_inner">
                            ...
                            <table className="list_TB" summary="리스트기본">
                                ...
                                <tbody>
                                <tr>
                                    <td colSpan={10} height='40'>등록된 상품이 없습니다.</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
