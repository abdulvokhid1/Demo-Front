...
const DistributionLimitProcessingStatistics = () => {
...
전체 : <b>1</b> 건  조회
					...
					<table className ="list_TB" summary="리스트기본">
						<thead>
							<tr>
								...
								<th scope="col" className ="colorset"><a href='/myAdmin/_entershop.bonus_no_beneath_list.php?code=&page=&filed=id&orderby=asc'><u>아이디</u></a></th>
								<th scope="col" className ="colorset"><a href='/myAdmin/_entershop.bonus_no_beneath_list.php?code=&page=&filed=owner_code&orderby=asc'><u>회원명</u></a></th>
								<th scope="col" className ="colorset"><a href='/myAdmin/_entershop.bonus_no_beneath_list.php?code=&page=&filed=memgrade&orderby=asc'><u>레벨</u></a></th>
								<th scope="col" className ="colorset"><a href='/myAdmin/_entershop.bonus_no_beneath_list.php?code=&page=&filed=mb_card_point&orderby=asc'><u>현재 페이</u></a></th>
								<th scope="col" className ="colorset"><a href='/myAdmin/_entershop.bonus_no_beneath_list.php?code=&page=&filed=mb_card_point&orderby=asc'><u>매출PV합산</u></a></th>
								{/* <!--<th scope="col" className ="colorset"><u>직추천 MS</u></th>--> */}
								{/* <!--<th scope="col" className ="colorset"><u>배당 지급액(월)</u></th>--> */}
								<th scope="col" className ="colorset"><a href='/myAdmin/_entershop.bonus_no_beneath_list.php?code=&page=&filed=total_acc&orderby=asc'><u>배당누적 지급액</u></a></th>
								...
								<th scope="col" className ="colorset"><a href='/myAdmin/_entershop.bonus_no_beneath_list.php?code=&page=&filed=signdate&orderby=asc'><u>업데이트날짜</u></a></th>
								<th scope="col" className ="colorset"><a href='/myAdmin/_entershop.bonus_no_beneath_list.php?code=&page=&filed=buymethod&orderby=asc'><u>관리</u></a></th>
							</tr>
						</thead> 
						<tbody>
	...
	<input type='hidden' name='od_table[0]' value='1'/>
							<tr>
								...
								<td>0 개
								&nbsp;<span className ="shop_btn_pack" style={{float:'right'}}><a href='_entershop.member_account.list.php?pass_sdate=&pass_edate=&pass_orderid=&app_mode=popup&pass_recomid=superadmin'onClick={()=>{}} className ="small gray" title="회원" >다구좌</a>&nbsp;</span>
								</td>
								{/* <!--<td>0--> */}
								{/* <!--<td>0--> */}
								<td>0								
								...
								<td>
									...
									<div  style={{display:'table',margin:'0 auto'}}>
														...
														<a href='_entershop.bonus_no_beneath_list_log_member.php?p_type=month&sh_year=2024&sh_month=03&pass_orderid=superadmin&app_mode=popup' onClick={()=>{}} className ="small gray">상세보기</a>
														<a href='_entershop.return.form.php?_mode=add&app_id=superadmin&gross_price=0&app_mode=popup' onClick={()=>{}} className ="small red">환급처리</a>
														</span>
									</div>
								</td> 
							</tr>
...
{/* <!--
						<span className ="shop_btn_pack"><a onclick="btn_check('delete')" className ="small white" title="선택삭제" >선택삭제</a></span>
						<span className ="shop_btn_pack"><span className ="blank_3"></span></span>
...
{/* <!--<span className ="shop_btn_pack"><a href="./_calcu.ad_rech_xls.php?code=" className ="small white" title="엑셀저장" >엑셀저장</a></span>--> */}
					...
					<div className ="list_paginate">			
							<span className ='lineup'><span className ='nextprev'><span className ='btn'><span className ='no'><span className ='icon ic_first'></span></span><a href='/myAdmin/_entershop.bonus_no_beneath_list.php?code=&page=1' className ='ok' title='처음' ><span className ='icon ic_first'></span></a></span><span className ='btn'><span className ='no'><span className ='icon ic_prev'></span></span><a href='/myAdmin/_entershop.bonus_no_beneath_list.php?code=&page=0' className ='ok' title='이전' ><span className ='icon ic_prev'></span></a></span></span><span className ='number'><a href='#none' onClick={()=>{return false}} className ='hit'>1</a></span><span className ='nextprev'><span className ='btn'><span className ='no'><span className ='icon ic_next'></span></span><a href='/myAdmin/_entershop.bonus_no_beneath_list.php?code=&page=2' className ='ok' title='다음' ><span className ='icon ic_next'></span></a></span><span className ='btn'><span className ='no'><span className ='icon ic_last'></span></span><a href='/myAdmin/_entershop.bonus_no_beneath_list.php?code=&page=1' className ='ok' title='끝' ><span className ='icon ic_last'></span></a></span></span></span></div>
					{/* <!-- // 페이지네이트 --> */}
	</form>
...
function chk_gonumber(val) {
    ...
    export default DistributionLimitProcessingStatistics;