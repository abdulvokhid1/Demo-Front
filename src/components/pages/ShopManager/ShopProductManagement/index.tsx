...
const ShopProductManagement = () => {
    ...
    const onSubmit = async (formData: FormData) => {
        ...
        const code = formData.get('pass_code');
        setNameState(name?.toString());
        setCodeState(code?.toString());
    ...
    const activeTriggerHandle = (id: number, isActive: boolean) => {
        mutateUpdate({
            id: id,
            isActive: isActive,
        })
            ...
            <div className="content_section">
                <div className="content_section_fix" style={{background: "#fff"}}>
                    ...
                    <td className="conts" colSpan={10}>
                      ...
                      3차분류 :{" "}
                      <select name="cateCode" id="pass_parent03" style={{ width: '130px',marginRight: '20px' }} >
                        <option value="">-선택-</option>
                      </select>
                    </td>
                  </tr> */}
                  ...
                  <span className="shop_btn_pack btn_input_blue">
                    ...
                    <span className="blank_3"></span>
                                    ...
                                    <span className="shop_btn_pack">
                    <a
                        href={PAGE_ROUTES.SHOP.PRODUCT_REGISTER}
                  ...
                  <span className="shop_btn_pack">
                    ...
                    {/* <!-- 상품일괄업로드 # LDD014 {--> */}
                    <form
                        action="_product_main.upload.php"
                        method="post"
                        ...
                        >
                                ...
                                <tr>
                                    <td className="conts" colSpan={2}>
                                        <div className="guide_text">
                                            ...
                                            <span className="blue">
                          상품 <b>등록</b>시 상품분류(카테고리)는 1개만 지정
                          가능하며 이미 등록되어있지 않은 분류(카테고리)는 제외
                          됩니다.
                        </span>
                                        </div>
                                        <div className="guide_text">
                          ...
                          바랍니다.
                                        ...
                                        <div className="guide_text">
                                            <span className="ic_blue"></span>
                                            <span className="blue">
                          <b>상품 사용 정보</b>, <b>업체 이용 정보</b>,{" "}
                                                <b>상품상세설명</b>, <b>상품 상세설명 (모바일)</b>,{" "}
                                                <b>주문확인서 주의사항</b>의 내용은 엔터를 제외 하고{" "}
                                                <b>HTML로 입력</b> 바랍니다.{" "}
                        </span>
                                        </div>
                                        <div className="guide_text">
                                            <span className="ic_blue"></span>
                                            <span className="blue">
                          상품이미지가 <b>외부이미지</b>일 경우 <b>http://</b>
                          부터 시작하도록 입력 바랍니다.
                        </span>
                                        </div>
                                        <div className="guide_text">
                                            <span className="ic_blue"></span>
                                            <span className="blue">
                          상품이미지가 <b>내부이미지</b>일 경우{" "}
                                                <b>./upfiles/product/ 폴더에 사전 업로드</b>를 하시고
                          엑셀에는 <b>파일명과 확장자만 입력</b> 바랍니다.
                        </span>
                                        </div>
                                        <div className="guide_text">
                                            <span className="ic_blue"></span>
                  ...
                  <span className="shop_btn_pack btn_input_blue">
                    ...
                    <span className="blank_3"></span>
                                    ...
                                    <span className="shop_btn_pack">
                    <a
                        href="_product_main.download.php"
                        className="medium white"
                        title="엑셀다운로드"
                    >
                      엑셀다운로드
                ...
                {/*</span>*/}
                                ...
                                {/*    <a href="#none" className="small white" title="선택 상품일괄삭제"*/}
                                {/*       onClick={() => {}}*/}
                                {/*    >*/}
                                {/*        선택 상품일괄삭제*/}
                                {/*    </a>*/}
                                ...
                                {productList?.length && (
                                    productList?.map((item: any, index: number) => (
                                        <tr key={index}>
                                            ...
                                            {/*        name="serialnum[]"*/}
                                            {/*        value="10"*/}
                                            {/*        className="className_ordernum className_pcode"*/}
                                            {/*    />*/}
                                            {/*</td>*/}
                                            {/*<td>*/}
                                            {/*    노출*/}
                                            ...
                                            <td>
                                                <img
                                                    src={`${domain}/api/v1/upload/${item.mainlocal?.id}`}
                                                    style={{width: "100px"}}
                                                />
                                            </td>
                                            <td style={{textAlign: "left", paddingLeft: "5px"}}>
                                                [카테고리] {item.categories?.length && (
                                                item.categories.map((category: any, i: number) => (
                                                    <span key={i}> <br/>{category.category.name}</span>
                                                ))
                                            )
                                            }
                                                <br/>
                                            ...
                                            <td>
                                                <span className="shop_state_pack">
                                                    <span
                                                        className={item.isActive ? 'orange' : 'gray'}>{item.isActive ? '노출' : '숨김'
                                                    }</span>
                                                </span>
                                            </td>
                                            <td>
                                                <div className="btn_line_up_center">
                                                    ...
                                                    <span className="shop_btn_pack">
                                                        <input type="button" name="" className={item.isActive? 'input_small gray' : 'input_small magenta'} value={item.isActive? '숨김' : '노출'}
                                                               onClick={() => {
                                                                   item.isActive
                                                                       ? activeTriggerHandle(item.id, false)
                                                                       : activeTriggerHandle(item.id, true)
                                                               }}
                                                        />
                                                    </span>
                                                </div>
