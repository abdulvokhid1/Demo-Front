...
<div className="content_section_inner">
  ...
  <span className="shop_btn_pack"><span className="blank_3"></span></span>
    <span className="shop_btn_pack"><a href="javascript:mass_dan4();" className="small red" title="일괄배송준비중" >배송중처리</a></span>
    <span className="shop_btn_pack"><span className="blank_3"></span></span>
    <span className="shop_btn_pack"><a href="javascript:mass_dan3();" className="small red" title="일괄배송준비중" >배송대기처리</a></span>
    <span className="shop_btn_pack"><span className="blank_3"></span></span>
    <span className="shop_btn_pack"><a href="javascript:mass_dan1();" className="small gray" title="일괄주문확인처리" >주문확인처리</a></span>
