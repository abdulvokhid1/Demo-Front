                ...
                <div className="content_section_fix" style={{ background: '#fff' }}>
                            ...
                            <tbody>
                                <tr style={{ height: "40", alignItems: "left" }} >
                                    <td style={{ padding: "5px" }}>
                                        ※ 후원 합계 :  <b style={{ color: '#e16007', fontWeight: 'bold' }}></b>   원&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table className="list_TB" summary="리스트기본">
                        ...
                        <tr>
								...
								<th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_assets_sponid.php?code=&amp;app_mode=popup&amp;page=&amp;filed=id&amp;orderby=asc"><u>아이디</u></a></th>
								<th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_assets_sponid.php?code=&amp;app_mode=popup&amp;page=&amp;filed=owner_code&amp;orderby=asc"><u>회원명</u></a></th>
								<th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_assets_sponid.php?code=&amp;app_mode=popup&amp;page=&amp;filed=memgrade&amp;orderby=asc"><u>레벨</u></a></th>
								{/* <!--<th scope="col" className="colorset"><a href='/myAdmin/_entershop.bonus_no_assets_sponid.php?code=&app_mode=popup&page=&filed=mb_card_point&orderby=asc'><u>수당</u></a></th>--> */}

								{/* <!--<th scope="col" className="colorset"><a href='/myAdmin/_entershop.bonus_no_assets_sponid.php?code=&app_mode=popup&page=&filed=total_price&orderby=asc'><u>매출금액</u></a></th>--> */}
								<th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_assets_sponid.php?code=&amp;app_mode=popup&amp;page=&amp;filed=total_pv&amp;orderby=asc"><u> 회원매출</u></a></th>
								{/* <!--<th scope="col" className="colorset"><u>배당자격 </u></th>--> */}
								<th scope="col" className="colorset"><u>좌(명)</u></th>
								<th scope="col" className="colorset"><u>우(명)</u></th>
								...
								{/* <!--<th scope="col" className="colorset"><a href='/myAdmin/_entershop.bonus_no_assets_sponid.php?code=&app_mode=popup&page=&filed=signdate&orderby=asc'><u>최근날짜</u></a></th>--> */}
								<th scope="col" className="colorset"><u>조직도</u></th>
								<th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_assets_sponid.php?code=&amp;app_mode=popup&amp;page=&amp;filed=buymethod&amp;orderby=asc"><u>관리</u></a></th>
							</tr>
                        </thead>
                        <tbody>
