		...
		<div className="content_section">
			<div className="content_section_fix" style={{ background: '#fff' }}>
				...
				<div className="title_area">
                    ...
                    <span className="location">홈 &gt; 주문관리 &gt; 주문처리현황</span>
                  </div>
                  {/* <!-- // 페이지타이틀 --> */}
           ...
           <div className="common_ajax_proc"></div>
				...
				{/* <!-- 검색영역 --> */}
<form name='searchfrm' method='post' action='/myAdmin/_order.list_all.php'>
...
<input type='hidden' name='odcode' value="1"/>
  ...
  <tr>
    <td className="article">회원타입</td><td className="conts">
        ...
        <td className="article">구매기기</td> <td className="conts" colSpan={3}>
    ...
    <option value='N' >PC구매</option>
				...
				<tr>
				<td className="article">구매승인날짜</td>
     			<td className="conts" colSpan={10}>
				<input type='text' name="buy_sdate" id="buy_sdate" className='input_text' value="" readOnly style={{width:'100px'}}/>
				<div className='guide_text'><span className='ic_blue'></span><span className='blue'><b>날짜선택하시고 검색을 누르면 선택됩니다</b></span></div>								</td>
				</tr>
					<tr>
					<td className="conts" colSpan={6}>
						<div className='guide_text'><span className='ic_blue'></span><span className='blue'><b>주문정보를 삭제할 경우 상품 재고량과 회원이 사용한 적립금이 환원되지 않습니다.</b></span></div>									<div className='guide_text'><span className='ic_blue'></span><span className='blue'>상품의 재고량과 회원이 사용한 적립금이 환원되기를 바란다면 반드시 <span style={{color:'red', fontWeight:'bold'}}> 주문취소로 처리 하셨다가 삭제</span>하시기 바랍니다.</span></div>									<div className='guide_text'><span className='ic_blue'></span><span className='blue'><b>회원주문</b>인 경우 <b>주문번호가 볼드체(굵은글씨)로 표시</b> 됩니다.</span></div>									<div className='guide_text'><span className='ic_blue'></span><span className='blue'>주문내역에 대한 <b>엑셀파일</b>은 검색조건에 맞는 내역만 저장됩니다.</span></div>								</td>
						</tr>
						</tbody> 
					</table>
...
<div className="form_box_area">
	<table className="form_TB" summary="검색항목">
		...
		<tbody>
			...
			<tr>
				<td className="article">주문금액합계</td>
				<td className="conts"><b></b>원
									</td>
				<td className="article">주문건수</td>
				<td className="conts"><b>0</b>개</td>
			</tr>

			<tr>
				<td className="article">주문PV</td>
			...
			<tr>
				...
				<td className="conts"  colSpan="10"><B>0</B>원
...
<input type='hidden' name='_search_que' value="IHdoZXJlIChvcmRlcl90eXBlID0gJ2NvdXBvbicgb3Igb3JkZXJfdHlwZSA9ICdwcm9kdWN0Jyk="/>
<input type='hidden' name='odcode' value=""/>
				...
				<div className="content_section_inner">
					...
					<div className="top_btn_area">
						...
						<span className="shop_btn_pack"><span className="blank_3"></span></span>
						<span className="shop_btn_pack"><span className="blank_3"></span></span>
						<span className="shop_btn_pack" style={{float:'right'}}><a href="javascript:buy_auth_cancel();" className="small red" title="구매승인" >구매승인취소</a></span>
						<span className="shop_btn_pack"><span className="blank_3"></span></span>
					...
					<table className="list_TB" summary="리스트기본">
						<thead>
							<tr>
								...
								<th scope="col" className="colorset">주문PV</th>
