			...
			<div className="content_section">
				<div className="content_section_fix" style={{ background: '#fff' }}>
					...
					<div className="title_area">
						...
						<span className="location">홈 &gt; 상품관리 &gt; 메인진열관리 - 전체상품</span>
					</div>
					{/* <!-- // 페이지타이틀 --> */}
					...
					<div className="form_box_area">
						<div className="top_btn_area">
							...
							<div style={{ width: '300px', float: 'left' }}>
								...
								<span style={{ fontWeight: 'bold', fontSize: '30px', textAlign: 'left' }}>타입 : 전체상품</span>
							</div>
			...
			location.reload();
							...
							<div className="btn_line_up_center">
								<span className="shop_btn_pack btn_input_blue">
									<input type="button" className="input_medium" title="상품 등록" value="상품등록"
										onClick={() => { router.push(PAGE_ROUTES.SHOP.PRODUCT_REGISTER) }} /></span>
							</div>
						</div>
					</div>
					{/* <!-- 버튼영역 --> */}
							...
							<table className="list_TB" summary="리스트기본">
								...
								<tbody>
									...
									<tr>
										...
										<td>8</td>
										<td style={{ textAlign: 'left', paddingLeft: '5px' }}><img src='http://thesen.moinus.kr/upfiles/product_t31/2311675546.jpg' style={{ width: '100px' }} /></td>
										...
										<td>
											...
											<br /><div className='btn_line_up_center' style={{ margin: '5px' }}>
