...
개인정보는 동의 철회 시점까지 보관 됩니다.</textarea>
                        ...
                        <!--
<tr>
    <td className="article">[선택] 개인정보수집 및 이용 동의<br>(회원가입)</td>
    <td className="conts">
                <div className="line">
            <span className="shop_btn_pack" style="float:none;"><input type="button" className="input_small white" style="" onclick="policy_add(this,'optional_privacyinfo')" value="+ 개인정보수집 및 이용 동의 추가"></span>
        </div>
        <div className="line">
            <input type="hidden" name="_appname[]" value="optional_privacyinfo">
            * 사용여부 : <span className='multi' ><label for='optional_privacyinfo_useY'><input type=radio id='optional_privacyinfo_useY' name='optional_privacyinfo_use' value='Y'  className=""  > 사용</label></span>&nbsp;&nbsp;&nbsp;<span className='multi' ><label for='optional_privacyinfo_useN'><input type=radio id='optional_privacyinfo_useN' name='optional_privacyinfo_use' value='N'  className="" checked > 미사용</label></span>&nbsp;&nbsp;&nbsp;        </div>
                <div className="line">
            <input type="hidden" name="optional_privacyinfo_uid[]" value="">
            <input type="text" name="optional_privacyinfo_title[]" className="input_text" value="" style="margin-bottom:3px; width:70%">
            <br>
            <textarea name="optional_privacyinfo_content[]" className="input_text" style="width:99%;height:200px;" ></textarea>
        </div>
                <div className='guide_text'><span className='ic_blue'></span><span className='blue'>선택적 동의항목은 업체상황에 맞게 사용여부와 내용을 작성하여 사용해 주시기 바랍니다. </span></div>    </td>
</tr>

<tr>
    <td className="article">[선택] 개인정보 처리ㆍ위탁 동의<br>(회원가입)</td>
    <td className="conts">
                <div className="line">
            <input type="hidden" name="_appname[]" value="optional_consign">
            * 사용여부 : <span className='multi' ><label for='optional_consign_useY'><input type=radio id='optional_consign_useY' name='optional_consign_use' value='Y'  className=""  > 사용</label></span>&nbsp;&nbsp;&nbsp;<span className='multi' ><label for='optional_consign_useN'><input type=radio id='optional_consign_useN' name='optional_consign_use' value='N'  className="" checked > 미사용</label></span>&nbsp;&nbsp;&nbsp;        </div>
        <div className="line">
            <span className="shop_btn_pack" style="float:none;"><input type="button" className="input_small white" style="" onclick="policy_add(this,'optional_consign')" value="+ 개인정보 처리ㆍ위탁 동의 추가"></span>
        </div>
                <div className="line">
            <input type="hidden" name="optional_consign_uid[]" value="">
            <input type="text" name="optional_consign_title[]" className="input_text" value="" style="margin-bottom:3px; width:70%">
            <br>
            <textarea name="optional_consign_content[]" className="input_text" style="width:99%;height:200px;" ></textarea>
        </div>
                <div className='guide_text'><span className='ic_blue'></span><span className='blue'>선택적 동의항목은 업체상황에 맞게 사용여부와 내용을 작성하여 사용해 주시기 바랍니다. </span></div>    </td>
</tr>

<tr>
    <td className="article">[선택] 개인정보 제3자 제공 동의<br>(회원가입)</td>
    <td className="conts">
                <div className="line">
            <input type="hidden" name="_appname[]" value="optional_thirdinfo">
            * 사용여부 : <span className='multi' ><label for='optional_thirdinfo_useY'><input type=radio id='optional_thirdinfo_useY' name='optional_thirdinfo_use' value='Y'  className=""  > 사용</label></span>&nbsp;&nbsp;&nbsp;<span className='multi' ><label for='optional_thirdinfo_useN'><input type=radio id='optional_thirdinfo_useN' name='optional_thirdinfo_use' value='N'  className="" checked > 미사용</label></span>&nbsp;&nbsp;&nbsp;        </div>
        <div className="line">
            <span className="shop_btn_pack" style="float:none;"><input type="button" className="input_small white" style="" onclick="policy_add(this,'optional_thirdinfo')" value="+ 개인정보 제3자 제공 동의 추가"></span>
        </div>
                <div className="line">
            <input type="hidden" name="optional_thirdinfo_uid[]" value="">
            <input type="text" name="optional_thirdinfo_title[]" className="input_text" value="" style="margin-bottom:3px; width:70%">
            <br>
            <textarea name="optional_thirdinfo_content[]" className="input_text" style="width:99%;height:200px;" ></textarea>
        </div>
                <div className='guide_text'><span className='ic_blue'></span><span className='blue'>선택적 동의항목은 업체상황에 맞게 사용여부와 내용을 작성하여 사용해 주시기 바랍니다. </span></div>    </td>
</tr>
--> */}
