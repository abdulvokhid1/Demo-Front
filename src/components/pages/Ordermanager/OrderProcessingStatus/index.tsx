      ...
      <div className="content_section">
        <div className="content_section_fix" style={{ background: "#fff" }}>
          ...
          <div className="title_area">
            ...
            <span className="title">주문처리현황</span>
          ...
          <form
            name="searchfrm"
            method="post"
            action="/myAdmin/_order.list_all.php"
          >
...
--> */}
          ...
          >
            ...
            <input
              type="hidden"
              name="_search_que"
              value="IHdoZXJlIChvcmRlcl90eXBlID0gJ2NvdXBvbicgb3Igb3JkZXJfdHlwZSA9ICdwcm9kdWN0Jyk="
            />
            ...
            <div className="content_section_inner">
              ...
              <div className="top_btn_area">
                ...
                <span className="shop_btn_pack" style={{ float: "right" }}>
                  <a
                    href="javascript:buy_auth_cancel();"
                    className="small red"
                    title="구매승인"
                  >
                    구매승인취소
