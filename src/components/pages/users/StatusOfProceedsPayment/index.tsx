                        ...
                        <div className="form_box_area">
                            <table className="form_TB" summary="검색항목">
                                ...
                                <tr>
                                    ...
                                    <td className="conts"><input type='text' name='pass_mb_id' className='input_text'
                                                                 value=""/></td>
                                    <td className="article">적립/변경 사유</td>
                                    <td className="conts"><input type='text' name='pass_wr_content'
                                                                 className='input_text' value=""/></td>
                                    <td className="article">지급일</td>
                                    <td className="conts"><input type='text' name='pass_wr_datetime'
                                                                 className='input_text' value=""/></td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <div className="top_btn_area">
                                <div className="btn_line_up_center">
                                    ...
                                    <span className="shop_btn_pack"><a href={PAGE_ROUTES.USERS.PAY_MANAGER}
                                                                       className="medium red" title="관리자 적립">관리자 적립</a></span>
                    ...
                    <form name='frm' method='post'>
                        ...
                        <div className="content_section_inner">
							...
							<col width="120px"/><col width="200px"/><col width="120px"/><col width="*"/>
                                ...
                                <tbody>
                                <tr>
                                    <td colSpan={15} height='40'>내용이 없습니다.</td>
                                </tr>
                                </tbody>
                            </table>
