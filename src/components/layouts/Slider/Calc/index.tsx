...
const Slider = () => {
    return (
        <div className="aside_second">
            ...
            <Link href={PAGE_ROUTES.CALC.CALC_MANAGEMENT} className="menu" title="대리점 인센티브" style={{display: 'block'}}>매출 정산하기</Link>
            <Link href={PAGE_ROUTES.CALC.CALC_RECOMMEND_INCENTIVES} className="menu" title="추천수당" style={{display: 'block'}}>대리점 수당</Link>
            ...
            <Link href={PAGE_ROUTES.CALC.CALC_POSITION_INCENTIVES_LIST} className="menu" title="판매 인센티브" style={{display: 'block'}}>매출 정산내역</Link>
            <Link href={PAGE_ROUTES.CALC.CALC_RECOMMEND_INCENTIVES_LIST} className="menu" title="대리점 인센티브" style={{display: 'block'}}>대리점수당 정산내역</Link>
