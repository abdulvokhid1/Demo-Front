                    ...
                    <form name='PUBLIC_FORM' method='post'>
                        ...
                        <div className="form_box_area">
                            ...
                            <table className="form_TB" summary="검색항목">
                                ...
                                <tr>
                                    <td className="conts">
                                        <iframe name='list1' src='_category_shop.pro.php?depth=1' width='100%'
                                                height='400'
                                                style={{textAlign: 'center', border: '2px solid #c1c1c1'}}></iframe>
                                    </td>
                                    <td className="conts">
                                        <iframe name='list2' src='' width='100%' height='400'
                                                style={{textAlign: 'center', border: '2px solid #c1c1c1'}}></iframe>
                                    </td>
                                    <td className="conts">
                                        <iframe name='list3' src='' width='100%' height='400'
                                                style={{textAlign: 'center', border: '2px solid #c1c1c1'}}></iframe>
                                    </td>
                                </tr>
                                </tbody>
