...
const Slider = () => {
    ...
    return (
        <div className="aside_second">
            ...
            <Link key={6} href={Routes.GENERAL.DASHBOARD} className={selectedKey==6? "menu_on": "menu"} title="상품문의 관리" style={{display: 'block'}}
                  onClick={()=> itemClickedHandler(6)}>상품문의 관리</Link>
            <Link key={1} href={Routes.GENERAL.CUSTOMER_INQUIRY_MANAGEMENT} className={selectedKey==1? "menu_on": "menu"} title="고객문의 관리" style={{display: 'block'}}
                  onClick={()=> itemClickedHandler(1)}>고객문의 관리</Link>
            <Link key={2} href={Routes.GENERAL.ADVERTISING_REQUEST} className={selectedKey==2? "menu_on": "menu"} title="제휴/광고문의 관리" style={{display: 'block'}}
                  onClick={()=> itemClickedHandler(2)}> 제휴/광고문의 관리</Link>
            <Link key={3} href={Routes.GENERAL.INQUIRY_BOARD} className={selectedKey==3? "menu_on": "menu"} title="일대일문의 게시판" style={{display: 'block'}}
            ...
            <Link key={5} href={Routes.GENERAL.DASHBOARD} className={selectedKey==5? "menu_on": "menu"} title="댓글 통합관리" style={{display: 'block'}}
            ...
            <Link key={8} href={Routes.GENERAL.DASHBOARD} className={selectedKey==8? "menu_on": "menu"} title="서브관리자 정보수정" style={{display: 'none'}}
            ...
            <Link key={12} href={Routes.GENERAL.PAGE_MANAGEMENT} className={selectedKey==12? "menu_on": "menu"} title="일반페이지 관리" style={{display: 'block'}}
                  onClick={()=> itemClickedHandler(12)}>일반페이지 관리</Link>
            <Link href={Routes.GENERAL.DASHBOARD} className={selectedKey==13? "menu_on": "menu"} title="서브관리자 관리" style={{display: 'none'}}
