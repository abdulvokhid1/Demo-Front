...
const AllOrderManagement = () => {
 ...
 <div className="common_ajax_proc"></div>
				...
				{/* <!-- 검색영역 --> */}
<form name='searchfrm' method='post' action='/myAdmin/_order2.list_all.php'>
...
<input type='hidden' name='odcode' value=""/>
	...
	<tr>
		...
		<td className="conts"><select name='pass_seller' ><option value=''>-공급업체-</option></select></td>
		...
		<td className="conts">
			  ...
			  <select name='_option_center' id="_option_center" className='add_option add_option_chk'>
	...
	<tr>
		...
		<input type="radio" name='pms_type' value="" checked/>&nbsp;전체&nbsp;&nbsp;
		<input type="radio" name='pms_type' value="product" />&nbsp;일반상품&nbsp;&nbsp;
		<input type="radio" name='pms_type' value="setup_product" />&nbsp;셋업상품&nbsp;&nbsp;
		</td>
	</tr>
						</tbody> 
					</table>
					...
					<div className='guide_text'><span className='ic_blue'></span><span className='blue'>쿠폰(상품) 일괄발송 및 재발송을 할 수 있습니다.</span></div>				</div>
</form>
				{/* <!-- // 검색영역 --> */}
					...
					<table className="form_TB" summary="검색항목">
						...
						<tbody>
							...
							<tr>
								...
								<td className="conts" colSpan={10}><b> PV</b>
								{/* <!--&nbsp;&nbsp;|&nbsp;&nbsp;상품주문 MS 합산 : <B>0 MS</B>--> */}
								</td>
							</tr>
							<tr>
								<td className="article">결제가</td>
								<td className="conts"  colSpan={10}><b></b>원
								<div className='guide_text'><span className='ic_blue'></span><span className='blue'> 1.공급가방식 : 결제가 = ( 공급가 + 옵션공급가 ) x 판매수량 + 배송비 </span></div>	
								<div className='guide_text'><span className='ic_blue'></span><span className='blue'> 2.수수료방식 : 결제가 = (1 - 수수료) x 상품판매가 x 판매수량 + 배송비 </span></div></td>
							</tr>
		...
		<form name='OderAllDelete' method='post' action="_order2.pro.php">
			...
			<input type='hidden' name='_search_que' value="IHdoZXJlIChvcmRlcl90eXBlID0gJ2NvdXBvbicgb3Igb3JkZXJfdHlwZSA9ICdwcm9kdWN0JykgYW5kIG9wX2NhbmNlbCA9ICdOJyA="/>
			<input type='hidden' name='delivstatus' value=''/>
			<input type='hidden' name='ordertype' value=''/>
					...
					<table className="list_TB" summary="리스트기본">
						<thead>
							<tr>
								...
								<th scope="col" className="colorset"><input type="checkbox" name="allchk" onClick={()=>{return false}} value="Y"/></th>
								...
								<th scope="col" className="colorset">상품가격</th>
								<th scope="col" className="colorset">수량</th>
								<th scope="col" className="colorset">주문가격</th>
								<th scope="col" className="colorset">주문일<br/>결제일</th>
								<th scope="col" className="colorset">배송상태</th>
								<th scope="col" className="colorset">구매확정일</th>
