					...
					<table className="form_TB" summary="검색항목">
						...
						<tbody>
							<tr>
								...
								<td className="conts"><input type='text' name="pass_recname" className='input_text' value=""/></td>
								
							</tr>
							<tr>
								<td className="conts" colSpan={6}>
									<div className='guide_text'><span className='ic_blue'></span><span className='blue'><b>회원주문</b>인 경우에는 <b>주문번호가 볼드체(굵은글씨)로 표시</b> 됩니다.</span></div>								</td>
							</tr>
						</tbody> 
					</table>
...
<input type='hidden' name='search_que' value="IHdoZXJlIGNhbmNlbGVkPSdZJyBBTkQgb3JkZXJzdGF0dXM9J1kn"/>
