                ...
                <div className="content_section_fix" style={{background: '#fff'}}>
                            ...
                            <div className="top_btn_area">
                                <div className="btn_line_up_center">
                                    ...
                                    <span className="shop_btn_pack"><a
                                        href="_entershop.bonus_return.form.php?_loc=&_mode=add&app_mode="
                                        className="medium red" title="출금신청">출금신청</a></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <form name='frm' method='post'>
                        ...
                        <div className="content_section_inner">
                            ...
                            <div className="top_btn_area">
                                <span className="shop_btn_pack"><a href="javascript:select_excel_send();"
                                                                   className="small white" title="선택엑셀다운로드">선택엑셀다운로드</a></span>
                                <span className="shop_btn_pack"><span className="blank_3"></span></span>
                                <span className="shop_btn_pack"><a href="javascript:search_excel_send();"
                                                                   className="small white"
                                                                   title="검색엑셀다운로드">검색엑셀다운로드(0)</a></span>
                                <span className="shop_btn_pack" style={{float: 'right'}}><a
                                    href="javascript:select_update_send();" className="small blue" title="선택완료처리"
                                    style={{borderRadius: 0}}>선택완료처리</a></span>
                            </div>
							...
							<col width="120px"/><col width="200px"/><col width="120px"/><col width="*"/>
                                ...
                                <tbody>
                                <tr>
                                    <td colSpan={30} height='40'>내용이 없습니다.</td>
                                </tr>
                                </tbody>
                            </table>
                            <div style={{
