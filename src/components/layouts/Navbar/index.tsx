...
const NavElement = () => {
    ...
    return (
        <div className="nav_admin" >
            <div className="layout_fix" style={{justifyContent:'center', alignItems:'center', textAlign:'center'}}>
                <div className="nav_admin_box "style={{justifyContent:'center', alignItems:'center', textAlign:'center'}}>
                    <ul style={{justifyContent:'center', alignItems:'center', textAlign:'center'}}>
                        ...
                        <li className={selectedKey == 4 ? "hit" : ""}>
                            <Link href={PAGE_ROUTES.ORGANIZATION_TREE.SPONSOR}
                                  className="btn"
                                  onClick={() => itemClickedHandler(4)}>조직도
                            </Link>
                        </li>
