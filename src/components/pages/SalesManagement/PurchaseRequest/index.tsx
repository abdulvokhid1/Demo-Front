                ...
                <div className="content_section_fix" style={{background: '#fff'}}>
                        ...
                        <div className="form_box_area">
                            <table className="form_TB" summary="검색항목">
                                ...
                                <tr>
                                    ...
                                    <td className="conts"><input type='text' name='pass_pointID' className='input_text'
                                                                 value=""/></td>
                                    ...
                                    <td className="conts">
                                        ...
                                        <select name='assign_center' id="assign_center"
                                                className='add_option add_option_chk' style={{width: '200px'}}>
                    ...
                    <form name='fboardlist' method='post'>
                        ...
                        <div className="content_section_inner">
                            {/* <!-- 리스트 제어버튼영역 //--> */}
                            <div className="top_btn_area">
                                <span className="shop_btn_pack"><a href="javascript:select_excel_rech();"
                                                                   className="small white" title="선택엑셀다운로드">선택엑셀다운로드</a></span>
                                <span className="shop_btn_pack"><span className="blank_3"></span></span>
                                <span className="shop_btn_pack"><a href="javascript:search_send('excel_rech');"
                                                                   className="small white"
                                                                   title="검색엑셀다운로드">검색엑셀다운로드(0)</a></span>
                            ...
                            <table className="list_TB" summary="리스트기본">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" className="colorset"><a
                                        href='/myAdmin/_calcu.ad_saving.list.php?code=&page=&filed=orderno&orderby=asc'><u>아이디</u></a>
                                    </th>
                                    <th scope="col" className="colorset"><a
                                        href='/myAdmin/_calcu.ad_saving.list.php?code=&page=&filed=odrkey&orderby=asc'><u>회원명</u></a>
                                    </th>
                                    <th scope="col" className="colorset">소속대리점</th>
                                    <th scope="col" className="colorset"><a
                                        href='/myAdmin/_calcu.ad_saving.list.php?code=&page=&filed=wr_pay_method&orderby=asc'><u>결제수단</u></a>
                                    </th>
                                    <th scope="col" className="colorset"><a
                                        href='/myAdmin/_calcu.ad_saving.list.php?code=&page=&filed=wr_wdate&orderby=asc'><u>신청
                                        금액</u></a></th>
                                    ...
                                    <th scope="col" className="colorset"><a
                                        href='/myAdmin/_calcu.ad_saving.list.php?code=&page=&filed=wr_wdate&orderby=asc'><u>적용금액</u></a>
                                    </th>
                                    <th scope="col" className="colorset"><a
                                        href='/myAdmin/_calcu.ad_saving.list.php?code=&page=&filed=del_name&orderby=asc'><u>등록일</u></a>
                                    </th>
                                    <th scope="col" className="colorset"><a
                                        href='/myAdmin/_calcu.ad_saving.list.php?code=&page=&filed=ismember&orderby=asc'><u>내용</u></a>
                                    </th>
                                    <th scope="col" className="colorset"><a
                                        href='/myAdmin/_calcu.ad_saving.list.php?code=&page=&filed=ismember&orderby=asc'><u>상태</u></a>
                                    </th>
                                    <th scope="col" className="colorset"><a
                                        href='/myAdmin/_calcu.ad_saving.list.php?code=&page=&filed=ismember&orderby=asc'><u>처리</u></a>
                                    </th>
                                </tr>
                                </thead>
                                ...
                                <tbody>
                                <tr>
                                    <td height={50} colSpan={12} align='center'>내역이 없습니다.</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
