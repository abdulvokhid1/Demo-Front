...
const upload_popup = () => {
	...
	{/* <div className="open_close">
		<span className="btn_close" id={"open_close_btn_open"} title="메뉴닫기"></span>
...
<div className="option_data_top_type2 if_open">
  <div className="txt_box">상품옵션 일괄업로드 </div>
  ...
  <form action="_product_option.upload_excel_pro.php" name="wFrm" method="post" encType="multipart/form-data">
	  ...
	  <input type="hidden" name="pass_mode" value=""/>
	  <input type="hidden" name="pass_code" value=""/>
	  <input type="hidden" name="pass_use_dateoption" value=""/> 			
