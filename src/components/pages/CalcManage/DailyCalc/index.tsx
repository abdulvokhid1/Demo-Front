					...
					<div>
						...
						<div className="content_section_inner">
							...
							<div id="grid_table" className="tui-grid-container" data-grid-id="1">
								...
								<div className="tui-grid-content-area">
									<div className="tui-grid-lside-area" style={{ display: 'block', width: '163px' }} >
									...
									<div className="tui-grid-body-area" style={{ height: "557px" }}><div className="tui-grid-body-container" style={{ height: "0px" }}>
										...
										<div className="tui-grid-layer-selection" style={{ display: 'block', left: '0px', width: '70px' }}></div>
								...
								<div className="tui-grid-rside-area" style={{ display: 'block', width: '1004px', marginLeft: "163px" }}>
									<div className="tui-grid-head-area" style={{ height: "49px" }}>
										...
										<div className="tui-grid-column-resize-container" style={{ marginTop: '-50px', height: '50px', display: 'block' }}>
											...
											<div data-column-index="3" data-column-name="total_bonus" className="tui-grid-column-resize-handle " style={{ left: "218px" }} title="마우스 드래그를 통해 컬럼의 넓이를 변경할 수 있고,더블클릭을 통해 넓이를 초기화할 수 있습니다."></div>
											...
											<div data-column-index="5" data-column-name="app_right_recomid" className="tui-grid-column-resize-handle " style={{ left: "933px" }} title="마우스 드래그를 통해 컬럼의 넓이를 변경할 수 있고,더블클릭을 통해 넓이를 초기화할 수 있습니다."></div>
											<div data-column-index="6" data-column-name="app_right_sponid" className="tui-grid-column-resize-handle tui-grid-column-resize-handle-last" style={{ left: "984px" }} title="마우스 드래그를 통해 컬럼의 넓이를 변경할 수 있고,더블클릭을 통해 넓이를 초기화할 수 있습니다."></div></div></div><div className="tui-grid-body-area" style={{ height: "557px" }}>
											...
											<div className="tui-grid-table-container" style={{ top: '0px', overflow: 'visible' }}>
												...
												<table className="tui-grid-table">
													<colgroup>
														...
														<col data-column-name="memgrade" style={{ width: "71px" }} />
														<col data-column-name="total_bonus" style={{ width: "71px" }} />
														<col data-column-name="memo" style={{ width: "71px" }} />
														<col data-column-name="app_right_recomid" style={{ width: "71px" }} />
														<col data-column-name="app_right_sponid" style={{ width: "71px" }} />
													</colgroup>
													<tbody>
													</tbody>
												</table>
									...
									<div className="tui-grid-scrollbar-right-bottom"></div></div>
							...
							<div className="tui-grid-layer-editing tui-grid-cell-content">
