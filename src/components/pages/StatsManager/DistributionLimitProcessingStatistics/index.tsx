...
import { DistributionType } from '@/utils/types/type';
    ...
    const {mutate: mutateLevel} = useMutation(
        {
            ...
            onSuccess: async (values: any) => {
                setDistributionType(values);
                console.log(JSON.stringify(distributionType))
            },
            onError: (error: any) => {
    ...
    const {isPending, mutate, isSuccess, isError} = useMutation(
        {
            mutationFn: USER_API.getList,
            onSuccess: async (values: any) => {
                setDistributionType(values.PayManager);
