				...
				<div className="form_box_area">
					...
					<table className="form_TB" summary="검색항목">
						<tbody> 
							<tr>
								...
								<td className="conts"><input type="text" name="pass_title" className="input_text" value=""/></td>
							</tr>
						</tbody> 
					</table>
					...
					<div className="top_btn_area">
						<div className="btn_line_up_center">
							...
							<span className="shop_btn_pack"><a href="_normalpage.form.php?_mode=add" className="medium red" title="페이지등록" >페이지등록</a></span>
			...
			<tr>
				...
				<td>
					<div className='btn_line_up_center'>
						...
						<span className='shop_btn_pack'><span className='blank_3'></span></span>
						<span className='shop_btn_pack'>
                            <input type="button" value='삭제' className='input_small gray'  onClick={()=>{}}/></span>
					</div>
				</td>
			</tr>
