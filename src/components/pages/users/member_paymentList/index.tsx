                    ...
                    <table className="list_TB" summary="리스트기본">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_rebate_list.php?code=&amp;app_mode=popup&amp;page=&amp;filed=id&amp;orderby=asc"><u>아이디</u></a></th>
                                <th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_rebate_list.php?code=&amp;app_mode=popup&amp;page=&amp;filed=owner_code&amp;orderby=asc"><u>회원명</u></a></th>
                                <th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_rebate_list.php?code=&amp;app_mode=popup&amp;page=&amp;filed=memgrade&amp;orderby=asc"><u>레벨</u></a></th>
                                <th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_rebate_list.php?code=&amp;app_mode=popup&amp;page=&amp;filed=mb_card_point&amp;orderby=asc"><u>현재 수당</u></a></th>
                                <th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_rebate_list.php?code=&amp;app_mode=popup&amp;page=&amp;filed=mb_card_point&amp;orderby=asc"><u>매출PV합산</u></a></th>
                                <th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_rebate_list.php?code=&amp;app_mode=popup&amp;page=&amp;filed=total_acc&amp;orderby=asc"><u>지급금액</u></a></th>
                                {/* <!--<th scope="col" className="colorset"><a href='/myAdmin/_entershop.bonus_no_rebate_list.php?code=&app_mode=popup&page=&filed=total_acc&orderby=asc'><u>보유잔액</u></a></th>--> */}
                                <th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_rebate_list.php?code=&amp;app_mode=popup&amp;page=&amp;filed=total_acc&amp;orderby=asc"><u>배당누적금액</u></a></th>
                                <th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_rebate_list.php?code=&amp;app_mode=popup&amp;page=&amp;filed=total_acc&amp;orderby=asc"><u>지급금액 비교</u></a></th>
                                <th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_rebate_list.php?code=&amp;app_mode=popup&amp;page=&amp;filed=total_acc&amp;orderby=asc"><u>환급처리(차감)</u></a></th>
                                <th scope="col" className="colorset"><u>배당한도(월)</u></th>
                                <th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_rebate_list.php?code=&amp;app_mode=popup&amp;page=&amp;filed=signdate&amp;orderby=asc"><u>업데이트날짜</u></a></th>
                                <th scope="col" className="colorset"><a href="/myAdmin/_entershop.bonus_no_rebate_list.php?code=&amp;app_mode=popup&amp;page=&amp;filed=buymethod&amp;orderby=asc"><u>관리</u></a></th>
                            </tr>
                        </thead>
                        <tbody>
