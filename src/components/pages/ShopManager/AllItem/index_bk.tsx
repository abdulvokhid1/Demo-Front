                                        ...
                                        <tr>
                                            ...
                                            <td className="conts" style={{border: '1px solid#ccc'}}>
                                                <input type='text' name='type_name'
                                                       style={{width: '40%', height: '30px'}} value=""
                                                       className='input_text'/>
                                                <span className="shop_btn_pack btn_input_gray" style={{float: 'right'}}>
                                        <input type="button" onClick={() => {
                                        }} className="input_medium" title="수정" value="수정"/></span>
	...
	if(xmlHttp.readyState == 4) {
		if(xmlHttp.status == 200) {
			...
			location.reload();
                                            ...
                                            <td className="conts" style={{border: '1px solid#ccc'}}>
                                                <input type='text' name='_type' style={{width: '40%', height: '30px'}}
                                                       value="best" className='input_text'/>
							...
							<span className="shop_btn_pack btn_input_blue">
                                <input type="button" className="input_medium" title="메인상품 추가하기" value="메인상품 추가하기"
                                       onClick={() => {
                                       }}/></span>
                            </div>
                        </div>
                    ...
                    <form name='frm' method='post' action="_product_main_setup.pro.php">
                        ...
                        <div className="content_section_inner">
                            ...
                            <div className="ctl_btn_area">
                                ...
                                }} className="small gray" title="선택상품순위수정">선택상품순위수정</a></span>
                                <span className="shop_btn_pack"><span className="blank_3"></span></span>
                                <span className="shop_btn_pack"><a href="#none" onClick={() => {
                                }} className="small gray" title="선택상품삭제">선택상품삭제</a></span>
                            </div>
                            {/* <!-- // 리스트 제어버튼영역 --> */}
                            ...
                            <table className="list_TB" summary="리스트기본">
                                ...
                                {/* 상품진열시작점 */}
                                <tr>
                                    <td><input type='checkbox' name='chk_pcode[]' value='177'
                                               className='className_pcode'/></td>
                                    {/* <!--<td><input type=checkbox name='chk_pcode[]' value='S4986872' className=className_pcode></td>--> */}
                                    <td><input type='text' name='chk_idx[S4986872]' value='1' className='input_text'
                                               style={{width: '30px'}}/></td>
                                    <td>8</td>
                                    <td style={{textAlign: 'left', paddingLeft: '5px'}}><img
                                        src='http://thesen.moinus.kr/upfiles/product_t31/2311675546.jpg'
